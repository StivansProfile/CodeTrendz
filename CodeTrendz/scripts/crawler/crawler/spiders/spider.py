...
class LinkedInJobsSpider(scrapy.Spider):
    name = "linkedin_jobs"
    api_url = "https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=software developer&location=United%2BKingodm&geoId=103644278&trk=public_jobs_jobs-search-bar_search-submit&start="
